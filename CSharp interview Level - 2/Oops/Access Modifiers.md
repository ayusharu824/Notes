...
|Within a derived class in the same assembly|Yes|
|Within a non-derived class in the same assembly|Yes|
|Within a derived class in another assembly|Yes|
|Within a non-derived class in another assembly|No|
